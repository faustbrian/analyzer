...
final readonly class TranslationAnalysisResolver implements AnalysisResolverInterface
{
    ...
    public function __construct(
        #[Config('analyzer.translation.lang_path')]
        ?string $langPath = null,
        #[Config('analyzer.translation.locales', ['en'])]
        private array $locales = ['en'],
        #[Config('analyzer.translation.report_dynamic', true)]
        private bool $reportDynamic = true,
        #[Config('analyzer.translation.vendor_path')]
        private ?string $vendorPath = null,
        #[Config('analyzer.translation.ignore', [])]
        private array $ignore = [],
        #[Config('analyzer.translation.include_patterns')]
        private ?array $includePatterns = null,
        ?Parser $parser = null,
        private ?BladeParser $bladeParser = new BladeParser(),
    ) {
        $this->langPath = $langPath ?? base_path('lang');
