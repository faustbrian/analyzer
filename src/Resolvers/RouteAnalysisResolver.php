...
final readonly class RouteAnalysisResolver implements AnalysisResolverInterface
{
    ...
    /**
     * Path to Laravel routes directory.
     */
    ...
    public function __construct(
        #[Config('analyzer.route.routes_path')]
        ?string $routesPath = null,
        #[Config('analyzer.route.cache_routes', true)]
        private bool $cacheRoutes = true,
        #[Config('analyzer.route.cache_ttl', 3_600)]
        private int $cacheTtl = 3_600,
        #[Config('analyzer.route.report_dynamic', true)]
        private bool $reportDynamic = true,
        #[Config('analyzer.route.include_patterns')]
        private ?array $includePatterns = null,
        #[Config('analyzer.route.ignore_patterns')]
